...
async function seed() {
  ...
  const ramith = await User.create({
    firstName: 'Ramith', lastName: 'Student', email: 'Ramith.student@homework.com', password: 'password123',
  ...
  const kavya = await User.create({
    firstName: 'Kavya', lastName: 'Teacher', email: 'Kavya.teacher@homework.com', password: 'password123',
  ...
  await User.create({
    firstName: 'Admin', lastName: 'User', email: 'admmin@homework.com', password: 'password123',
  ...
  const hw1 = await Homework.create({
    ...
    teacher: kavya._id, course: 'Bachelor of IT', classCode: 'IT-205',
  ...
  await Submission.create({
    submissionId: generateSubmissionId(), homework: hw1._id, student: ramith._id,
    ...
    gradedAt: offset(-1), gradedBy: kavya._id
  });
  await Submission.create({
    submissionId: generateSubmissionId(), homework: hw2._id, student: ramith._id,
  ...
  await Notification.insertMany([
    { recipient: ramith._id, title: 'New homework assigned', message: 'Software Requirements Specification has been assigned.', type: 'new_homework' },
    { recipient: ramith._id, title: 'Homework graded', message: 'SRS has been graded and feedback is available.', type: 'graded', isRead: false },
    { recipient: kavya._id, title: 'New submission received', message: 'A student submitted the requirements specification.', type: 'submission' },
    { recipient: liam._id, title: 'New homework assigned', message: 'Web Interface Prototype has been assigned.', type: 'new_homework' }
  ]);

  console.log('Seed complete.');
  console.log('Student: Ramith.student@homework.com / password123');
  console.log('Teacher: Kavya.teacher@homework.com / password123');
  console.log('Admin:   admmin@homework.com / password123');
